				...
				<view class="order-uinn">
					...
					<view class="ub am-btn-panel ub-ac">
						<template v-if="tabIndex == 0">
							<view class="ub ub-f1 ub-pe" v-if="isManager == 1">
								<view class="ub">
							...
							<view class="ub ub-f1 ub-pe" v-if="isManager == 2">
								<view class="ub">
									<button class="f24 am-btn-primary"  @click="reply(item)">回复</button>
								</view>
							</view>
							<view class="ub ub-f1 ub-pe am-text-danger" v-else>待处理</view>
						</template>
						<view class="ub ub-f1 ub-pe" v-if="tabIndex == 1">
							<view class="ub ub-f1 ub-pe" v-if="isManager == 1 || isManager == 0">
								<view class="ub ub-f1 ub-pe am-text-danger">等待用户评价</view>
							</view>
							<view class="ub ub-f1 ub-pe" v-else>
								<view class="ub">
